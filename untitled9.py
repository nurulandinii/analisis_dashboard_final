...
Original file is located at
    https://colab.research.google.com/drive/1mP75YSiFRlrYd2QKS9qSxMnDITZxixL1
"""
...
# LOAD DATA
# ==========================================================
df = pd.read_excel("/content/data_simulasi_50_siswa_20_soal (2).xlsx")
...
for i, row in cluster_mean.iterrows():
    ...
    ax_rad.plot(angles, values, label=row["Segment"])
